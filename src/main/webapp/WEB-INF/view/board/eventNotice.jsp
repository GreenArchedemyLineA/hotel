				...
				<div class="modal-content">
					...
					<div>
						<form action="/event/event-insert" method="post">
							<label>일정 시작 날짜</label> <input type="text" name="startDate" value="2015-10-13"> <br> <label>일정 종료 날짜</label> <input type="text" name="endDate" value="2015-10-13"> <br>
							<label>제목</label> <input type="text" name="title" value="asdsadasd"> <br> <label>내용</label> <input type="text" name="content" value="asdasdasdasd">
