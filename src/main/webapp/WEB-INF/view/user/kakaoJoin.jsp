	...
	<div class="content--container">
		<form action="/join" method="post" class="form--container">
			...
			<c:choose>
				...
				<c:otherwise>
					<input type="text" name="name" class="input--box" value="${user.profile.nickname}" readonly="readonly"> 								
				</c:otherwise>
			</c:choose>
			...
			<input type="tel" name="tel" class="input--box" placeholder="전화번호를 입력해주세요 (- 입력)">
