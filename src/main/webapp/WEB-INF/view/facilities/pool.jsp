	...
	<div class="body--container">
		<div class="navi--bar">
			...
			<div>
				...
				<span class="detail--box"><a href="/dining?type=라운지">라운지
						& 바</a></span> <span class="detail--box"><a href="/fitness">피트니스</a></span> <span
					class="detail--box selected--menu"><a href="/pool">수영장</a></span> <span
					class="detail--box"><a href="/spa">스파</a></span>
			</div>
		</div>
		<div class="main--container">
				...
				<div class="swiper mySwiper">
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="bx-group">
								<div>
									<img alt="수영장 사진" src="/images/${pool.facilities.image1}" width="1000px" height="500px">
								</div>
							</div>
						</div>
						<div class="swiper-slide">
							<div class="bx-group">
								<div>
									<img alt="수영장 사진" src="/images/${pool.facilities.image2}" width="1000px" height="500px">
								</div>
							</div>
						</div>
						<div class="swiper-slide">
							<div class="bx-group">
								<div>
									<img alt="수영장 사진" src="/images/${pool.facilities.image3}" width="1000px" height="500px">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="info--container">
				...
				<span class="info--title--desc">
					${pool.facilitiesDesc.titleDesc}</span>
